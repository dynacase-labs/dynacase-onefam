...
if (window.onefamParam.openfam) {
  addEvent(window,'load',function () {openfirst(window.onefamParam.openfam);});
}

addEvent(window,'load',function () {resizeIconList(window.onefamParam.colNumber);});
addEvent(window,'resize',function () {resizeIconListAtEnd(window.onefamParam.colNumber);});